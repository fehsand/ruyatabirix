...
urlpatterns = [
    ...
    path(_('ruyatabirleri/ruyada-'+'<slug:slug>'+'-gormek'), views.ruyatabirleri_ayrinti, name='ruyatabirleri_ayrinti'),
    path('ruyatabirleri/ruyada-<slug:slug>-gormek', views.ruyatabirleri_ayrinti, name='my_comment_was_posted'),
    re_path(_(r'^ruyatabirleri/ruyada-'+'(?P<slug>[-\w]+)'+'-gormek$'), views.ruyatabirleri_ayrinti_2, name='ruyatabirleri_ayrinti_2'),
    re_path(_(r'^ruyatabirleri/ruyada-'+'(?P<slug>[-\w]+)'+'-gormek$'), views.ruyatabirleri_ayrinti_2, name='my_comment_was_posted_2'),
